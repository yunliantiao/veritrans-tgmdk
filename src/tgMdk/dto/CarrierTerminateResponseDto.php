...
/**
 * 決済サービスタイプ：キャリア、コマンド名：継続終了の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class CarrierTerminateResponseDto extends MdkBaseDto
{
    ...
    /**
     * 継続課金終了日時（YYYYMMDDhhmmss）を取得する<br>
     * @return string 継続課金終了日時（YYYYMMDDhhmmss）<br>
     */
    ...
    /**
     * 継続課金終了日時（YYYYMMDDhhmmss）を設定する<br>
     * @param string $terminateDatetime 継続課金終了日時（YYYYMMDDhhmmss）<br>
     */
