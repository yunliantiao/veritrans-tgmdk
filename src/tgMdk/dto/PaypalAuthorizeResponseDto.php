 ...
 *
 */
class PaypalAuthorizeResponseDto extends MdkBaseDto
{
    ...
    /**
     * 決済センタ承認IDを取得する<br>
     * @return string 決済センタ承認ID<br>
     */
    public function getCenterAuthId()
    {
        return $this->centerAuthId;
    }

    /**
     * 決済センタ承認IDを設定する<br>
     * @param string $centerAuthId 決済センタ承認ID<br>
     */
    public function setCenterAuthId($centerAuthId)
    {
        $this->centerAuthId = $centerAuthId;
    }
