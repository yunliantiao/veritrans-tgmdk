...
/**
 * 決済サービスタイプ：銀行振込決済、コマンド名：消込取消の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class VirtualaccUndoReconcileRequestDto extends AbstractPaymentVirtualaccRequestDto
{
     ...
     * 必須項目、固定値<br>
     */
    private $SERVICE_COMMAND = "UndoReconcile";
