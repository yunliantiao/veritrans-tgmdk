...
/**
 * 決済サービスタイプ：merpay、コマンド名：決済申込の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class MerpayAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * 半角英数字記号<br/>
     * 最大桁数：2000<br/>
     * マーチャント側で加盟店アプリからMerpayアプリ間移動するURL<br/>
     */
    private $paymentUrl;
    ...
    /**
     * 決済開始URLを設定する<br>
     * @param string $paymentUrl 決済開始URL<br>
     */
