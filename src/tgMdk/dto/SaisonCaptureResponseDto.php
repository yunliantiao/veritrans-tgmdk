 ...
 *
 */
class SaisonCaptureResponseDto extends MdkBaseDto
{
    ...
    /**
     * trAd広告ＵＲＬ(カード決済用)を設定する<br>
     * @param string $cardTradUrl trAd広告ＵＲＬ(カード決済用)<br>
     */
    public function setCardTradUrl($cardTradUrl)
    {
        $this->cardTradUrl = $cardTradUrl;
    }

    /**
     * trAd広告ＵＲＬ(カード決済用)を取得する<br>
     * @return string trAd広告ＵＲＬ(カード決済用)<br>
     */
    public function getCardTradUrl()
    {
        return $this->cardTradUrl;
    }
