 ...
 *
 */
class CardAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * JCNトークン結果コード<br>
     */
    private $jcnTokenResultCode;

    /**
     * JCNトークン化カード番号<br>
     */
    private $jcnTokenMemberNum;
     ...
     * JCNトークン判定結果1<br>
     */
    private $jcnTokenResult1;

    /**
     * JCNトークン判定結果2<br>
     */
    private $jcnTokenResult2;

    /**
     * JCNトークンエラーレスポンスコード<br>
     */
    private $jcnTokenResCode;
    ...
    /**
     * JCNトークン結果コードを取得する<br>
     * @return string JCNトークン結果コード<br>
     */
    public function getJcnTokenResultCode()
    {
        return $this->jcnTokenResultCode;
    }

    /**
     * JCNトークン結果コードを設定する<br>
     * @param string $jcnTokenResultCode JCNトークン結果コード<br>
     */
    public function setJcnTokenResultCode($jcnTokenResultCode)
    {
        $this->jcnTokenResultCode = $jcnTokenResultCode;
    }

    /**
     * JCNトークン化カード番号を取得する<br>
     * @return string JCNトークン化カード番号<br>
     */
    public function getJcnTokenMemberNum()
    {
        return $this->jcnTokenMemberNum;
    }

    /**
     * JCNトークン化カード番号を設定する<br>
     * @param string $jcnTokenMemberNum JCNトークン化カード番号<br>
     */
    public function setJcnTokenMemberNum($jcnTokenMemberNum)
    {
        $this->jcnTokenMemberNum = $jcnTokenMemberNum;
    }
    ...
    /**
     * JCNトークン判定結果1を取得する<br>
     * @return string JCNトークン判定結果1<br>
     */
    public function getJcnTokenResult1()
    {
        return $this->jcnTokenResult1;
    }

    /**
     * JCNトークン判定結果1を設定する<br>
     * @param string $jcnTokenResult1 JCNトークン判定結果1<br>
     */
    public function setJcnTokenResult1($jcnTokenResult1)
    {
        $this->jcnTokenResult1 = $jcnTokenResult1;
    }

    /**
     * JCNトークン判定結果2を取得する<br>
     * @return string JCNトークン判定結果2<br>
     */
    public function getJcnTokenResult2()
    {
        return $this->jcnTokenResult2;
    }

    /**
     * JCNトークン判定結果2を設定する<br>
     * @param string $jcnTokenResult2 JCNトークン判定結果2<br>
     */
    public function setJcnTokenResult2($jcnTokenResult2)
    {
        $this->jcnTokenResult2 = $jcnTokenResult2;
    }

    /**
     * JCNトークンエラーレスポンスコードを取得する<br>
     * @return string JCNトークンエラーレスポンスコード<br>
     */
    public function getJcnTokenResCode()
    {
        return $this->jcnTokenResCode;
    }

    /**
     * JCNトークンエラーレスポンスコードを設定する<br>
     * @param string $jcnTokenResCode JCNトークンエラーレスポンスコード<br>
     */
    public function setJcnTokenResCode($jcnTokenResCode)
    {
        $this->jcnTokenResCode = $jcnTokenResCode;
    }
