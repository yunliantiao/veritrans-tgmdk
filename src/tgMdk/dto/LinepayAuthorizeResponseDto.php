...
/**
 * 決済サービスタイプ：LINEPay、コマンド名：与信の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class LinepayAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * 半角文字<br/>
     * 最大桁数：512<br/>
     * マーチャント側でコンシューマに対してweb画面上でリダイレクトするURLです。<br/>
     */
    private $redirectWebUrl;

    /**
     * LINEにアプリ間移動するURL<br>
     * 半角文字<br/>
     * 最大桁数：512<br/>
     * マーチャント側で加盟店アプリからLINEにアプリ間移動するURLです。<br/>
     */
    private $redirectAppUrl;
    ...
    /**
     * LINEPay取引IDを設定する<br>
     * @param string $linepayOrderId LINEPay取引ID<br>
     */
    ...
    /**
     * リダイレクトするWebURLを取得する<br>
     * @return string リダイレクトするWebURL<br>
     */
    public function getRedirectWebUrl()
    {
        return $this->redirectWebUrl;
    }

    /**
     * リダイレクトするWebURLを設定する<br>
     * @param string $redirectWebUrl リダイレクトするWebURL<br>
     */
    public function setRedirectWebUrl($redirectWebUrl)
    {
        $this->redirectWebUrl = $redirectWebUrl;
    }

    /**
     * LINEにアプリ間移動するURLを取得する<br>
     * @return string LINEにアプリ間移動するURL<br>
     */
    public function getRedirectAppUrl()
    {
        return $this->redirectAppUrl;
    }

    /**
     * LINEにアプリ間移動するURLを設定する<br>
     * @param string $redirectAppUrl LINEにアプリ間移動するURL<br>
     */
    public function setRedirectAppUrl($redirectAppUrl)
    {
