...
/**
 * 決済サービスタイプ：キャリア、コマンド名：金額変更の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class CarrierUpdateAuthorizeResponseDto extends MdkBaseDto
{
    ...
    /**
     * 金額変更日時（YYYYMMDDhhmmss）を取得する<br>
     * @return string 金額変更日時（YYYYMMDDhhmmss）<br>
     */
    ...
    /**
     * 金額変更日時（YYYYMMDDhhmmss）を設定する<br>
     * @param string $updateDatetime 金額変更日時（YYYYMMDDhhmmss）<br>
     */
