...
/**
 * 決済サービスタイプ：エポス、コマンド名：キャンセルの応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class EposCancelResponseDto extends MdkBaseDto
{
    ...
    /**
     * クレジット利用額を設定する<br>
     * @param string $useCredit クレジット利用額<br>
     */
    ...
    /**
     * クーポン利用額を設定する<br>
     * @param string $useCoupon クーポン利用額<br>
     */
    ...
    /**
     * ポイント利用額を設定する<br>
     * @param string $usePoint ポイント利用額<br>
     */
