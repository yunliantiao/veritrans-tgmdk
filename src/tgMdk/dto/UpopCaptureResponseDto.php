...
/**
 * 決済サービスタイプ：UPOP、コマンド名：売上の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class UpopCaptureResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * 銀聯ネット決済（UPOP）で売上が確定した日時（日本時間）を返します。<br/>
     */
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * 銀聯ネット決済（UPOP）で売上が確定した日時（中国時間）を返します。<br/>
     */
    ...
    /**
     * 売上金額を設定する<br>
     * @param string $capturedAmount 売上金額<br>
     */
