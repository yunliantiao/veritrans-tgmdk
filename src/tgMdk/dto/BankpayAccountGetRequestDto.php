...
/**
 * 決済サービスタイプ：bankpay、コマンド名：口座照会の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class BankpayAccountGetRequestDto extends AbstractPaymentRequestDto
{
     ...
     * 必須項目、固定値<br>
     */
    private $SERVICE_COMMAND = "AccountGet";
