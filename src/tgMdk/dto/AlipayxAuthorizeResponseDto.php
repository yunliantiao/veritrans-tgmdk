 ...
 *
 */
class AlipayxAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * serviceOptionType="barcode"の場合に返戻。<br/>
     */
    private $payTimeJp;
     ...
     * 最大桁数：1024<br/>
     * 識別コードを返します。<br/>
     * serviceOptionType="scancode"、かつ、scancodeType="0"の場合に返戻。<br/>
     */
     ...
     * 文字列<br/>
     * 最大桁数：1024<br/>
     * 支払い完了するためのアプリ内URLを返します。<br/>
     * serviceOptionType="scancode"の場合に返戻。<br/>
     */
    private $appPayUrl;
    ...
    /**
     * QRコード画像URLを設定する<br>
     * @param string $qrCodeImgUrl QRコード画像URL<br>
     */
     ...
     * @param string $qrCodeSmallImgUrl QRコード画像URL(小)<br>
     */
     ...
     * @param string $qrCodeLargeImgUrl QRコード画像URL(大)<br>
     */
    ...
    /**
     * アプリ内支払いURLを取得する<br>
     * @return string アプリ内支払いURL<br>
     */
    public function getAppPayUrl()
    {
    ...
    /**
     * アプリ内支払いURLを設定する<br>
     * @param string $appPayUrl アプリ内支払いURL<br>
     */
    public function setAppPayUrl($appPayUrl)
    {
        $this->appPayUrl = $appPayUrl;
    }
