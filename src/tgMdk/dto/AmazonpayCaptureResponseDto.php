...
/**
 * 決済サービスタイプ：Amazonpay、コマンド名：売上の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class AmazonpayCaptureResponseDto extends MdkBaseDto
{
     ...
     * 文字列<br/>
     * 最大桁数：14<br/>
     * 決済センターが売上要求に応答した日時<br/>
     * 正常終了した場合、Amazon側で売上要求を受け付けた日時となります。<br/>
     * ※売上が成立した日時は、結果通知をご参照ください。<br/>
     ...
     * Amazonから購入者へ送信するメールに、注文番号として表示されます。<br/>
     * - 最大:64byte<br/>
     */
