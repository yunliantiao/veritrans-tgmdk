...
/**
 * 決済サービスタイプ：Amazonpay、コマンド名：返金の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class AmazonpayRefundResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：8<br/>
     * 売上金額から返金要求中と返金済みの取引の金額を減算した値を返します。<br/>
     * ※応答時点で、部分返金が行える残りの金額となりますが、Amazon側の非同期処理により、返金要求中の取引が不成立となった場合は、返戻時点の値よりも大きくなることがあります。<br/>
     */
