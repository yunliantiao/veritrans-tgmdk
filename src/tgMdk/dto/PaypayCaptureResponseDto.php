...
/**
 * 決済サービスタイプ：paypay、コマンド名：売上の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class PaypayCaptureResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * paypay側で売上された日時を返却します。（YYYYMMDDhhmmss形式）<br/>
     * ※mstatus=successの場合、設定されます。<br/>
     */
    private $paypayCapturedDatetime;
    ...
    /**
     * paypay売上日時を取得する<br>
     * @return string paypay売上日時<br>
     */
    public function getPaypayCapturedDatetime()
    {
        return $this->paypayCapturedDatetime;
    }

    /**
     * paypay売上日時を設定する<br>
     * @param string $paypayCapturedDatetime paypay売上日時<br>
     */
    public function setPaypayCapturedDatetime($paypayCapturedDatetime)
    {
        $this->paypayCapturedDatetime = $paypayCapturedDatetime;
    }
