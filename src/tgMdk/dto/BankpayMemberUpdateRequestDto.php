...
/**
 * 決済サービスタイプ：bankpay、コマンド名：会員更新の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class BankpayMemberUpdateRequestDto extends AbstractPaymentRequestDto
{
     ...
     * 必須項目、固定値<br>
     */
    private $SERVICE_COMMAND = "MemberUpdate";
     ...
     * スマホなどのデバイスを識別するためのUUIDなどの情報を指定してください。EC利用などの場合は一意なランダムな値を指定してください。<br/>
     */
