...
/**
 * 決済サービスタイプ：スコア@払い、コマンド名：決済申込結果取得の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class ScoreatpayConfirmResponseDto extends MdkBaseDto
{
     ...
     *  - authorResultが"OK"、"NG"、"保留"の場合のみ返戻<br/>
     */
    private $authoriDate;
    ...
    /**
     * 保留理由<br>
     * ScoreatpayHoldReasonDtoの配列<br/>
     * 保留理由オブジェクトを配列で返却します。<br/>
     */
    private $holdReasons;
    ...
    /**
     * 審査時刻を取得する<br>
     * @return string 審査時刻<br>
     */
    public function getAuthoriDate()
    {
        return $this->authoriDate;
    }

    /**
     * 審査時刻を設定する<br>
     * @param string $authoriDate 審査時刻<br>
     */
    public function setAuthoriDate($authoriDate)
    {
        $this->authoriDate = $authoriDate;
    }
    ...
    /**
     * 保留理由を取得する<br>
     * @return ScoreatpayHoldReasonDto[] 保留理由<br>
     */
    ...
    /**
     * 保留理由を設定する<br>
     * @param ScoreatpayHoldReasonDto[] $holdReasons 保留理由<br>
     */
    public function setHoldReasons($holdReasons)
    {
    ...
    {
        return array('errors' => 'ScoreatpayErrorDto', 'holdReasons' => 'ScoreatpayHoldReasonDto');
    }
