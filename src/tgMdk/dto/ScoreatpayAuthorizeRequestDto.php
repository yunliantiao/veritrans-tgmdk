...
/**
 * 決済サービスタイプ：スコア@払い、コマンド名：決済申込の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class ScoreatpayAuthorizeRequestDto extends AbstractPaymentRequestDto
{
     ...
     *  - 2：請求書別送。<br/>
     *  - 3：請求書同梱サービス。<br/>
     *  - ※請求書同梱サービスは、購入者住所情報と配送先住所情報が完全に一致する場合のみ使用可能。<br/>
     */
    private $paymentType;
