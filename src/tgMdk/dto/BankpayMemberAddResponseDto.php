...
/**
 * 決済サービスタイプ：bankpay、コマンド名：会員登録の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class BankpayMemberAddResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * BankPay側で会員登録された日時を返却します。（YYYYMMDDhhmmss形式）<br/>
     */
    ...
    /**
     * 顧客IDを設定する<br>
     * @param string $merchantUserId 顧客ID<br>
     */
