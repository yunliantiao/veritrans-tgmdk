...
/**
 * 決済サービスタイプ：MasterPass、コマンド名：与信の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class MasterpassAuthorizeResponseDto extends MdkBaseDto
{
    ...
    /**
     * 取引日時（YYYYMMDDhhmmss）を取得する<br>
     * @return string 取引日時（YYYYMMDDhhmmss）<br>
     */
    ...
    /**
     * 取引日時（YYYYMMDDhhmmss）を設定する<br>
     * @param string $authorizeDatetime 取引日時（YYYYMMDDhhmmss）<br>
     */
    ...
    /**
     * カード決済取引IDを設定する<br>
     * @param string $cardOrderId カード決済取引ID<br>
     */
