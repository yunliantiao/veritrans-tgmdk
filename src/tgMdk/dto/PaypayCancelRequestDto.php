...
/**
 * 決済サービスタイプ：paypay、コマンド名：取消の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class PaypayCancelRequestDto extends AbstractPaymentRequestDto
{
     ...
     * 半角英数字<br/>
     * 最大桁数：100<br/>
     * 都度決済 : 与信取消対象の取引IDを指定します。<br/>
     * 随時決済 : 再与信で指定した取引IDを指定します。<br/>
     */
    private $orderId;
