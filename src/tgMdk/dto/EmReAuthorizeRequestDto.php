 ...
 *
 */
class EmReAuthorizeRequestDto extends AbstractPaymentRequestDto
{
    ...
    /**
     * 復旧リダイレクションURLを取得する<br>
     * @return string 復旧リダイレクションURL<br>
     */
    ...
    /**
     * 復旧リダイレクションURLを設定する<br>
     * @param string $reAuthorizeRedirectionUrl 復旧リダイレクションURL<br>
     */
