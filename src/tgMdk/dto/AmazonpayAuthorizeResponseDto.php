...
/**
 * 決済サービスタイプ：Amazonpay、コマンド名：決済申込の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class AmazonpayAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * レスポンスコンテンツ<br>
     * 文字列<br/>
     * マーチャント側でコンシューマに対して応答するHTMLコンテンツです。<br/>
     * 自動でAmazonPayの画面に遷移するためのJavaScriptを含みます。<br/>
     */
