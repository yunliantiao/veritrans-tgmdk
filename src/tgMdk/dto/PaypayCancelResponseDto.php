...
/**
 * 決済サービスタイプ：paypay、コマンド名：取消の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class PaypayCancelResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * paypay側で与信取消された日時を返却します。（YYYYMMDDhhmmss形式）<br/>
     * ※mstatus=successの場合、設定されます。<br/>
     */
    private $paypayCancelledDatetime;
    ...
    /**
     * paypay取消日時を取得する<br>
     * @return string paypay取消日時<br>
     */
    public function getPaypayCancelledDatetime()
    {
        return $this->paypayCancelledDatetime;
    }

    /**
     * paypay取消日時を設定する<br>
     * @param string $paypayCancelledDatetime paypay取消日時<br>
     */
    public function setPaypayCancelledDatetime($paypayCancelledDatetime)
    {
        $this->paypayCancelledDatetime = $paypayCancelledDatetime;
    }
