...
/**
 * 決済サービスタイプ：コンビニペイ、コマンド名：取消の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class CvspayCancelResponseDto extends MdkBaseDto
{
    ...
    /**
     * 取消要求日時（YYYYMMDDhhmmss）<br>
     * 半角数字<br/>
     * 最大桁数：14<br/>
     */
    private $cancelReqDatetime;
     ...
     * 半角数字<br/>
     * 最大桁数：10<br/>
     * ポイント利用キャンセル後の通常ポイント残高<br/>
     */
    private $balancePoint;
    ...
    /**
     * 取消要求日時（YYYYMMDDhhmmss）を取得する<br>
     * @return string 取消要求日時（YYYYMMDDhhmmss）<br>
     */
    public function getCancelReqDatetime()
    {
        return $this->cancelReqDatetime;
    }

    /**
     * 取消要求日時（YYYYMMDDhhmmss）を設定する<br>
     * @param string $cancelReqDatetime 取消要求日時（YYYYMMDDhhmmss）<br>
     */
    public function setCancelReqDatetime($cancelReqDatetime)
    {
    ...
    /**
     * キャンセルポイント数を取得する<br>
     * @return string キャンセルポイント数<br>
     */
    public function getCancelPoint()
    {
    ...
    /**
     * キャンセルポイント数を設定する<br>
     * @param string $cancelPoint キャンセルポイント数<br>
     */
    public function setCancelPoint($cancelPoint)
    {
    ...
    /**
     * ポイント残高を設定する<br>
     * @param string $balancePoint ポイント残高<br>
     */
    public function setBalancePoint($balancePoint)
    {
