...
/**
 * 決済サービスタイプ：paypay、コマンド名：返金の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class PaypayRefundResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * paypay側で返金された日時を返却します。（YYYYMMDDhhmmss形式）<br/>
     * ※mstatus=successの場合、設定されます。<br/>
     */
    private $paypayRefundedDatetime;
    ...
    /**
     * paypay返金日時を取得する<br>
     * @return string paypay返金日時<br>
     */
    public function getPaypayRefundedDatetime()
    {
        return $this->paypayRefundedDatetime;
    }

    /**
     * paypay返金日時を設定する<br>
     * @param string $paypayRefundedDatetime paypay返金日時<br>
     */
    public function setPaypayRefundedDatetime($paypayRefundedDatetime)
    {
        $this->paypayRefundedDatetime = $paypayRefundedDatetime;
    }
