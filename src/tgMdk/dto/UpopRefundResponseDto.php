...
/**
 * 決済サービスタイプ：UPOP、コマンド名：返金の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class UpopRefundResponseDto extends MdkBaseDto
{
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * 銀聯ネット決済（UPOP）で返金が確定した日時（日本時間）を返します。<br/>
     */
     ...
     * 半角数字<br/>
     * 最大桁数：14<br/>
     * 銀聯ネット決済（UPOP）で返金が確定した日時（中国時間）を返します。<br/>
     */
     ...
     * 半角数字<br/>
     * 最大桁数：12<br/>
     * 与信（売上同時）、与信後の売上に対する返金の場合の元売上金額 <br/>
     */
