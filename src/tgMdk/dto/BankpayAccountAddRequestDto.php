...
/**
 * 決済サービスタイプ：bankpay、コマンド名：口座登録の要求Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class BankpayAccountAddRequestDto extends AbstractPaymentRequestDto
{
     ...
     * 必須項目、固定値<br>
     */
    private $SERVICE_COMMAND = "AccountAdd";
