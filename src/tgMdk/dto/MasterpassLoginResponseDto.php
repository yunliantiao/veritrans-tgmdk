...
/**
 * 決済サービスタイプ：MasterPass、コマンド名：認証の応答Dtoクラス<br>
 *
 * @author Veritrans, Inc.
 *
 */
class MasterpassLoginResponseDto extends MdkBaseDto
{
     ...
     * レスポンスコンテンツ<br>
     * 文字列<br/>
     * マーチャント側でコンシューマに対して応答するHTMLコンテンツです。自動でMasterPassの画面に遷移するためのJavaScriptを含みます。<br/>
     * <br/>
     */
